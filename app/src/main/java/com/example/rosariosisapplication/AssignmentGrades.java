...
public class AssignmentGrades extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < HomePageActivity.classGrades.get(HomePageActivity.classnum).size(); i++) {
            ...
            tv0.setText(HomePageActivity.classGrades.get(HomePageActivity.classnum).get(1));
            tv0.setText(HomePageActivity.classGrades.get(HomePageActivity.classnum).get(3));
            tv0.setText(HomePageActivity.classGrades.get(HomePageActivity.classnum).get(4));
